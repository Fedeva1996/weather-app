...
const Footer = (props) => {
  return (
    <footer className="flex flex-col w-full justify-center items-center min-h-8 px-4 pb-2 mt-4 gap-2 border-t border-gray-300 dark:border-gray-800 sticky top-[100%] shrink-0 md:px-6">
